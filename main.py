...
from handlers import promt_handler, start_message, create_hero, load_hero
...
async def lifespan(app: FastAPI):
    ...
    dp.include_routers(start_message.router, promt_handler.router, create_hero.router, load_hero.router)
